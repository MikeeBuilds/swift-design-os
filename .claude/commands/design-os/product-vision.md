...
You are helping the user define their product vision for Swift DesignOS. This is a conversational, multi-step process.
...
"I'd love to help you define your product vision for your Swift/SwiftUI application. Tell me about the app you're building - share any notes, ideas, or rough thoughts you have. What problem are you trying to solve? Who is it for? What platforms are you targeting (iOS, macOS, watchOS, tvOS)? Don't worry about structure yet, just share what's on your mind."
...
- **The product name** - A clear, concise name for the app
...
- "What would you like to call this app? (A short, memorable name)"

Other example clarifying questions (adapt based on their input):
- "Who is the primary user of this app? Can you describe them?"
- "What's the single biggest pain point you're addressing?"
- "How do people currently solve this problem without your app?"
- "What makes your SwiftUI approach different or better?"
- "What are the 3-5 most essential features?"
- "Which Apple platforms do you plan to support? (iOS, macOS, watchOS, tvOS)"
...
- Consider SwiftUI/iOS specifics when appropriate (e.g., native iOS features, platform considerations)
